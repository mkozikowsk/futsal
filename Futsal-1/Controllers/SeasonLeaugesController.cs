...
namespace Futsal_1.Controllers
{
    public class SeasonLeaugesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Status,SeasonId")] SeasonLeauge seasonLeauge)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Status,SeasonId")] SeasonLeauge seasonLeauge)
        {
            if (ModelState.IsValid)
            {
